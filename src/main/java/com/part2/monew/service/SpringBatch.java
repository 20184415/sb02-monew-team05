...
import com.part2.monew.service.implement.NewsCrawlingApiServiceImpl;
import com.part2.monew.service.implement.NewsArticleService;
import com.part2.monew.service.newsinterface.NewsProvider;
...
public class SpringBatch {
    ...
    private Map<String, List<NewsArticle>> collectNewsFromApiWithKeywords(Map<String, List<String>> activeInterestKeywordsMap) {
        ...
        Map<String, List<NewsArticle>> apiArticlesByInterest = new java.util.HashMap<>();
    ...
    private Map<String, List<NewsArticle>> collectNewsFromRssWithKeywordFilter(Map<String, List<String>> activeInterestKeywordsMap) {
        ...
        Map<String, List<NewsArticle>> rssArticlesByProvider = new java.util.HashMap<>();
    ...
    /**
     * NewsArticleDto를 NewsArticle Entity로 변환
     */
